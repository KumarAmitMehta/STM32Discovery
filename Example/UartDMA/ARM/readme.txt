...
1.Data arrives from external world (through USB Serial COM port on PC to
...
5.Bus Matrix, ask Cortex Core to relinquish the System Bus. (H/W)
...
11.In the DMA ISR, this transfer complete flag is checked and once set,
